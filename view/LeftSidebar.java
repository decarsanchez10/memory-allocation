...
public class LeftSidebar extends JPanel {
    ...
    public LeftSidebar() {
        ...
        JLabel logoText = new JLabel("  Memory Sim");
        ...
        navSettings = new SidebarButton("Settings",   "\u2699");
        ...
        setMemBtn.setPreferredSize(new Dimension(48, 32));
        ...
        setProcBtn.setPreferredSize(new Dimension(48, 32));
    ...
    public SidebarButton getNavSettings()   { return navSettings; }

    /** Deactivates all nav buttons and activates only the specified one. */
    public void setActiveNav(SidebarButton active) {
        for (SidebarButton btn : new SidebarButton[]{navDash, navResults, navSettings}) {
